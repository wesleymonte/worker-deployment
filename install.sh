...
#NUMBER_OF_WORKERS=$(grep $DEPLOYED_WORKER_IP $HOSTS_CONF_FILE | wc -l)
...
# for counter in $(seq 1 ${NUMBER_OF_WORKERS})
# do
#   DEPLOYED_WORKER_IP_PATTERN="deployed_worker_ip_${counter}"
